...
export function Login({ url, withBack, loginTop, privacy, callback }) {
    ...
    */
    ...
    function PageIndex() {
        return _jsx(PagePublic, { header: header, footer: privacy, children: _jsxs("div", { className: "d-flex p-5 flex-column justify-content-center align-items-center", children: [_jsx("div", { className: "flex-fill" }, void 0), _jsxs("div", { className: "w-20c", children: [loginTop ?? _jsx("div", { className: "text-center p-3 fs-5 text-primary", children: "\u767B\u5F55" }, void 0), _jsx("div", { className: "h-2c" }, void 0), _jsxs(Form, { BandTemplate: AuthFormBandTemplate, children: [_jsx(BandString, { label: "\u767B\u5F55\u8D26\u53F7", name: "username", placeholder: "\u624B\u673A/\u90AE\u7BB1/\u7528\u6237\u540D", rule: ruleIsRequired, maxLength: 100 }, void 0), _jsx(BandPassword, { label: "\u5BC6\u7801", name: "password", placeholder: "\u5BC6\u7801", rule: ruleIsRequired, maxLength: 100 }, void 0), _jsx(Band, { children: _jsx(FormErrors, {}, void 0) }, void 0), _jsx(Band, { contentContainerClassName: "text-center my-3", children: _jsx(Submit, { onSubmit: onSubmit, children: _jsx("div", { className: 'mx-5', children: "\u767B\u5F55" }, void 0) }, void 0) }, void 0)] }, void 0), _jsxs("div", { className: "text-center", children: [_jsx(Link, { className: "btn btn-link", to: pathForget, children: "\u5FD8\u8BB0\u5BC6\u7801" }, void 0), _jsx(Link, { className: "btn btn-link", to: pathRegister, children: "\u6CE8\u518C\u8D26\u53F7" }, void 0)] }, void 0)] }, void 0), _jsx("div", { className: "flex-fill" }, void 0), _jsx("div", { className: "flex-fill" }, void 0)] }, void 0) }, void 0);
    }
